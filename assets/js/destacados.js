...
(function () {
  ...
  function buildCard(m) {
    ...
    card.innerHTML =
      '<div class="fc-header">' +
        (leagueLogo
          ? '<img src="' + esc(leagueLogo) + '" alt="' + esc(leagueName) + '" data-fallback-icon="league" class="fc-league-logo lazy-img" loading="lazy">'
          : '') +
      ...
      '<div class="fc-teams">' +
        '<div class="fc-team">' +
          (homeLogo ? '<img src="' + esc(homeLogo) + '" alt="' + esc(homeName) + '" data-fallback-icon="team" class="fc-team-logo lazy-img" loading="lazy">' : '') +
          '<span class="fc-team-name">' + esc(homeName) + '</span>' +
        '</div>' +
        '<div class="fc-vs">VS</div>' +
        '<div class="fc-team">' +
          (awayLogo ? '<img src="' + esc(awayLogo) + '" alt="' + esc(awayName) + '" data-fallback-icon="team" class="fc-team-logo lazy-img" loading="lazy">' : '') +
  ...
  function logoSrc(logo) {
    ...
    return BASE + 'assets/img/equipos/fm/' + encodeURIComponent(v) + '.png';
  }
